    ...
    function ProjectCardHeader(){
        return (
            <div className="flex justify-between items-center">
                ...
                {/* More Options */}
            <div>
                <MoreVerIcon className="text-slate-400 text-[19px] cursor-pointer"/>
                </div>
                </div>
        );
    }
      ...
      return (
        <ul className="text-slate-400 text-[13px] flex flex-col gap-2 ml-3">
          <li className="flex gap-2 items-center">
            ...
            <span>
              Lorem ipsum dolor, sit amet consectetur adipiscing elit. Odit
            </span>
          </li>
    ...
    function ProjectCardFooter(){
        return(
            <div className="flex gap-4 flex-col mt-2">
                ...
                <div className="text-[12px] gap-3 ite,s-center flex w-full">
                <div className="w-full h-[7px] rounded-xl bg-slate-100 overflow-hidden">
                    <div className="w-1/2 bg-orange-600 h-full rounded-r-xl">
                    </div>
                </div>
            </div>
            <div className="flex justify-between">
                <p className="text-[13px] text-slate-400">On Progess</p>
