...
function AddProjectButton(){
    ...
    return(
        ...
        <button className=" bg-orange-600 text-white px-2  text-[14px] rounded-md flex gap-1 items-center p-2 pr-3 max-sm:pr-2">
            <AddIcon sx={{ fontSize: "22px"}} className="mt-[2px]" />
            <span className="max-sm:hidden">New Projects</span>
        </button>
        <MenuIcon className="text-slate-400 h-9 cursor-pointer hidden max-[942px]:block"/>
        </div>
    );
}
}
